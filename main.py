...
from flask_login import UserMixin, login_manager, login_required, login_user, LoginManager, current_user, logout_user
...
class BlogPost(db.Model):
    ...
    comments: Mapped[List["Comment"]] = relationship(back_populates="post_parent")
...
class Comment(db.Model):
    ...
    post_parent: Mapped["BlogPost"] = relationship(back_populates="comments")
